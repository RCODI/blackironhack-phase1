2. Keywords : Google Map, Disease, Range


3. Description of the datasets and function design
 * CDC database. http://wonder.cdc.gov/wonder/help/WONDER-API.html
 ...
 * Use data from CDC to map disease areas and severness 
 ...
 * Map View:
	...
	4. [Y] InfoWindow to show detail information of a marker
